...
export const HIGH_CONTRAST_THEMES: { id: string; name: string; bg: string; text: string; accent: string }[] = [
...
export const DYSLEXIA_FONTS = [
  { label: 'OpenDyslexic', value: 'OpenDyslexic, sans-serif', url: 'https://cdn.jsdelivr.net/npm/open-dyslexic@1.0.3/woff/OpenDyslexic-Regular.woff2' },
