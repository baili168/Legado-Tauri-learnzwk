...
<template>
  <div
    class="reader-bottom-bar reader-bottom-bar-new reader-toolbar"
    :class="{
      'reader-bottom-bar--hidden': visible === false,
      'reader-toolbar--vertical': isWideLayout,
    }"
...
.reader-toolbar--vertical {
  ...
  align-items: center;
  gap: 12px;
  font-size: calc(1rem * var(--ui-font-scale) + 2px);
}

.reader-toolbar--vertical.reader-bottom-bar--hidden {
